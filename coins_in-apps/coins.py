...
if G.DEVICE:
    ...
    if width >= 1200 and height >= 800:  # Adjust based on typical tablet resolutions
        ...
        subsequent_crop_box = (50, 1395, 1050, 1650)  # Crop box for all other screenshots
...
initial_crop_box = (1900, 35, 2300, 135)  # Crop box for the first screenshot
...
def perform_touch_and_update_coins(template_path, coin_increment, variable_to_match):
    ...
    enhanced_screenshot_path = os.path.join(r'C:\\Users\\Hamza.Naseer\\Downloads\\Game In-Apps Automation using Airtest Project\\coins_in-apps\\Enhanced Images\\', f"enhanced_image_{screenshot_counter}.png")
    ...
    # Perform touch action and increment coins
...
if not exists(Template(r"tpl1729682994210.png", record_pos=(-0.0, -0.003), resolution=(2560, 1600))):
    ...
    sleep(6)
    perform_touch_and_update_coins(r"tpl1730883540360.png", 2500, (2500, 2300.00))
    sleep(6)
